...
exports.ImageKassiopeiaProcessingTool = void 0;
var ImageKassiopeiaProcessingTool = /** @class */ (function () {
    function ImageKassiopeiaProcessingTool() {
    }
    ImageKassiopeiaProcessingTool.prototype.convertFileToWebpBlobWithClipping = function (file, width, height, quality) {
        var _this = this;
    ...
    ImageKassiopeiaProcessingTool.prototype.convertFileToWebpBlobWithoutClipping = function (file, quality) {
        var _this = this;
        if (quality === void 0) { quality = 0.9; }
        return new Promise(function (resolve) {
            try {
    ...
    ImageKassiopeiaProcessingTool.prototype.convertFileToJpegBlobWithClipping = function (file, width, height, quality) {
        var _this = this;
        if (width === void 0) { width = 192; }
        if (height === void 0) { height = 192; }
        if (quality === void 0) { quality = 0.9; }
    ...
    ImageKassiopeiaProcessingTool.prototype.convertFileToJpegBlobWithoutClipping = function (file, quality) {
        var _this = this;
        if (quality === void 0) { quality = 0.9; }
        return new Promise(function (resolve) {
            try {
    ...
    ImageKassiopeiaProcessingTool.prototype.blobToDataURL = function (blob, type) {
        var _this = this;
        if (!type)
            type = 'jpeg';
        return new Promise(function (resolve) {
    ...
    ImageKassiopeiaProcessingTool.prototype.resizeHeight = function (img, width, height) {
        return new Promise(function (resolve) {
    ...
    ImageKassiopeiaProcessingTool.prototype.resizeWidth = function (img, width, height) {
        return new Promise(function (resolve) {
            var cv = document.createElement('canvas');
            var context = cv.getContext('2d');
    ...
    ImageKassiopeiaProcessingTool.get = function () {
...
//# sourceMappingURL=ImageKassiopeiaProcessingTool.js.map