export declare class ImageKassiopeiaProcessingTool {
    ...
    convertFileToWebpBlobWithClipping(file: File, width?: number, height?: number, quality?: number): Promise<Blob>;
    convertFileToWebpBlobWithoutClipping(file: File, quality?: number): Promise<Blob>;
    convertFileToJpegBlobWithClipping(file: File, width?: number, height?: number, quality?: number): Promise<Blob>;
