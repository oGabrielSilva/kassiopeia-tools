...
var Toaster = /** @class */ (function () {
    ...
    Toaster.prototype.configureYourself = function () {
        var _this = this;
        var _a = this.config.container, useVectorWithPercentage = _a.useVectorWithPercentage, position3D = _a.position3D, border = _a.border, maxWidth = _a.maxWidth, boundary = _a.boundary, centerOnScreen = _a.centerOnScreen, cursor = _a.cursor, borderRadius = _a.borderRadius;
        ...
        this.container = (0, html_1.generateHTML)({
            ...
            css: __assign(__assign(__assign({ overflow: 'hidden', zIndex: position3D.z, position: 'fixed', cursor: cursor ? cursor : 'default', maxWidth: typeof maxWidth === 'string' ? maxWidth : this.defaultMaxWidth }, (borderRadius ? { borderRadius: borderRadius } : {})), (typeof border === 'object'
                ? {
