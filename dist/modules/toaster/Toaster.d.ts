...
export declare class Toaster {
    ...
    protected readonly anim: KassiopeiaAnimationTool;
    ...
    constructor(message: string, config: IToasterSpecificConfig, onClick?: (event: Event, target: HTMLElement, context: Toaster) => void, onHide?: (context: Toaster) => void, anim?: KassiopeiaAnimationTool);
